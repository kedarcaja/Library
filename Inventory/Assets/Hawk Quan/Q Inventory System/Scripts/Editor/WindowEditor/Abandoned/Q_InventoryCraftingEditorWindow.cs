...
public class Q_InventoryCraftingEditorWindow : Q_InventoryEmptyEditorWindow {
    ...
    void BluePrintSetupReorderableListOnAddDropdownCallback()
    {
        ...
        //    {
        //        if (inventoryItemList.gameObjectData == null || inventoryItemList.gameObjectData.Count == 0)
        //        {
        //            EditorApplication.Beep();
        //            EditorUtility.DisplayDialog("Error", "You don't have any .gameObjectData defined in the Database", "Ok");
        //            return;
        //        }

...
public class PlayerPickUp : MonoBehaviour {
    ...
    //{
    //    Gizmos.DrawWireSphere(Q_GameMaster.Instance.inventoryManager.player.transform.position + Q_GameMaster.Instance.inventoryManager.player.transform.forward * rayDistance, radius);
    //}
}

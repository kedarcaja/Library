...
public class Stat : MonoBehaviour
{
	...
	{
		//if (PlayerScript.Instance.Stats.SkillPoints == 0) { Debug.Log("<color=red>You dont have enough skill points</color>"); return; };
  //      PlayerScript.Instance.Stats.SkillPoints--;
		//summ++;
